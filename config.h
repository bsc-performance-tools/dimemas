...
#define DATE "Wed Apr 26 18:25:45 CEST 2017"
...
/* #undef IDLE_ACCOUNTING */

/* Paraver 'logical recv' events will we located when MPI_wait is called */
/* #undef LOGICAL_RECEIVE_ALS_WAIT */

/* Define to the sub-directory where libtool stores uninstalled libraries. */
#define LT_OBJDIR ".libs/"

/* "Dimemas won't show compilation information" */
/* #undef NO_COMPILATION_INFO */

/* Name of package */
#define PACKAGE "dimemas"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "tools@bsc.es"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Dimemas"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Dimemas 5.3.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "dimemas"
