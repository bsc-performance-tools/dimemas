...
static char *DimemasSDDF[ DIMEMASSDDF_LINES ] = { "SDDFA;;",
                                                  "",
                                                  "#1:",
                                                  "\"CPU burst\" {",
                                                  "\tint      \"taskid\";",
...
static char *DimemasBlockDef[ BLOCKDEF_LINES ] = { "\"block definition\" {   1, \"MPI_Allgather\", \"MPI\", 0, 0 };;",
...
/* ---------------------------------------------------- Global Variables ----*/
#define COLLECTIVEDEF_LINES 16
static char *DimemasCollectiveDef[ COLLECTIVEDEF_LINES ] = { "\"global OP definition\" { 0, \"MPI_Barrier\" };;",
                                                             ...
                                                             "\"global OP definition\" {14, \"MPI_Reduce_Scatter_block\" };;",
                                                             "\"global OP definition\" {14, \"MPI_Alltoallw\" };;" };
...
int Dimemas_NX_One_Sided( FILE *fd, int task, int thread, int one_sided_opid, int handle, int tgt_thid, int msg_size )
{
#define NX_ONE_SIDED_STRING "\"1sided OP\" { %d, %d, %d, %d, %d, %d };;\n"
  return fprintf( fd, NX_ONE_SIDED_STRING, task, thread, one_sided_opid, handle, tgt_thid, msg_size );
}
