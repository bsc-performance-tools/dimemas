...
MPI_Enable MPI_Table[ NUM_MPICALLS ] = {
  ...
  /* 017 */
  { MPITYPE_COLLECTIVE, MPI_ALLGATHER_VAL, MPI_ALLGATHER_LABEL, BLOCK_ID_MPI_Allgather, GLOP_ID_MPI_Allgather, FALSE },
  /* 018 */
  { MPITYPE_COLLECTIVE, MPI_ALLGATHERV_VAL, MPI_ALLGATHERV_LABEL, BLOCK_ID_MPI_Allgatherv, GLOP_ID_MPI_Allgatherv, FALSE },
  /* 019 */
  ...
  /* 194 */
  { MPITYPE_COLLECTIVE, MPI_COMM_SPLIT_TYPE_VAL, MPI_COMM_SPLIT_TYPE_LABEL, BLOCK_ID_MPI_Comm_split_type, GLOP_ID_NULL, FALSE },
  /* 195 */
  { MPITYPE_COLLECTIVE, MPI_FILE_WRITE_ALL_BEGIN_VAL, MPI_FILE_WRITE_ALL_BEGIN_LABEL, BLOCK_ID_MPI_File_write_all_begin, GLOP_ID_NULL, FALSE },
  /* 196 */
  { MPITYPE_COLLECTIVE, MPI_FILE_WRITE_ALL_END_VAL, MPI_FILE_WRITE_ALL_END_LABEL, BLOCK_ID_MPI_File_write_all_end, GLOP_ID_NULL, FALSE },
  /* 197 */
  { MPITYPE_COLLECTIVE, MPI_FILE_READ_ALL_BEGIN_VAL, MPI_FILE_READ_ALL_BEGIN_LABEL, BLOCK_ID_MPI_File_read_all_begin, GLOP_ID_NULL, FALSE },
  /* 198 */
  { MPITYPE_COLLECTIVE, MPI_FILE_READ_ALL_END_VAL, MPI_FILE_READ_ALL_END_LABEL, BLOCK_ID_MPI_File_read_all_end, GLOP_ID_NULL, FALSE },
  /* 199 */
  { MPITYPE_COLLECTIVE, MPI_FILE_WRITE_AT_ALL_BEGIN_VAL, MPI_FILE_WRITE_AT_ALL_BEGIN_LABEL, BLOCK_ID_MPI_File_write_at_all_begin, GLOP_ID_NULL, FALSE },
  /* 200 */ 
  { MPITYPE_COLLECTIVE, MPI_FILE_WRITE_AT_ALL_END_VAL, MPI_FILE_WRITE_AT_ALL_END_LABEL, BLOCK_ID_MPI_File_write_at_all_end, GLOP_ID_NULL, FALSE },
  /* 201 */
  { MPITYPE_COLLECTIVE, MPI_FILE_READ_AT_ALL_BEGIN_VAL, MPI_FILE_READ_AT_ALL_BEGIN_LABEL, BLOCK_ID_MPI_File_read_at_all_begin, GLOP_ID_NULL, FALSE },
  /* 202 */
  { MPITYPE_COLLECTIVE, MPI_FILE_READ_AT_ALL_END_VAL, MPI_FILE_READ_AT_ALL_END_LABEL, BLOCK_ID_MPI_File_read_at_all_end, GLOP_ID_NULL, FALSE },
  /* 203 */
  { MPITYPE_COLLECTIVE, MPI_FILE_READ_ORDERED_VAL, MPI_FILE_READ_ORDERED_LABEL, BLOCK_ID_MPI_File_read_ordered, GLOP_ID_NULL, FALSE },
  /* 204 */
  { MPITYPE_COLLECTIVE, MPI_FILE_READ_ORDERED_BEGIN_VAL, MPI_FILE_READ_ORDERED_BEGIN_LABEL, BLOCK_ID_MPI_File_read_ordered_begin, GLOP_ID_NULL, FALSE },
  /* 205 */
  { MPITYPE_COLLECTIVE, MPI_FILE_READ_ORDERED_END_VAL, MPI_FILE_READ_ORDERED_END_LABEL,  BLOCK_ID_MPI_File_read_ordered_end, GLOP_ID_NULL, FALSE },
  /* 206 */
  { MPITYPE_COLLECTIVE, MPI_FILE_READ_SHARED_VAL, MPI_FILE_READ_SHARED_LABEL, BLOCK_ID_MPI_File_read_shared, GLOP_ID_NULL, FALSE },
  /* 207 */
  { MPITYPE_COLLECTIVE, MPI_FILE_WRITE_ORDERED_VAL, MPI_FILE_WRITE_ORDERED_LABEL, BLOCK_ID_MPI_File_write_ordered, GLOP_ID_NULL, FALSE },
  /* 208 */
  { MPITYPE_COLLECTIVE, MPI_FILE_WRITE_ORDERED_BEGIN_VAL, MPI_FILE_WRITE_ORDERED_BEGIN_LABEL, BLOCK_ID_MPI_File_write_ordered_begin, GLOP_ID_NULL, FALSE },
  /* 209 */
  { MPITYPE_COLLECTIVE, MPI_FILE_WRITE_ORDERED_END_VAL, MPI_FILE_WRITE_ORDERED_END_LABEL, BLOCK_ID_MPI_File_write_ordered_end, GLOP_ID_NULL, FALSE },
  /* 210 */
  { MPITYPE_COLLECTIVE, MPI_FILE_WRITE_SHARED_VAL, MPI_FILE_WRITE_SHARED_LABEL, BLOCK_ID_MPI_File_write_shared, GLOP_ID_NULL, FALSE },
  /* 211 */
  { MPITYPE_COLLECTIVE, MPI_COMM_DUP_WITH_INFO_VAL, MPI_COMM_DUP_WITH_INFO_LABEL, BLOCK_ID_MPI_Comm_dup_with_info, GLOP_ID_NULL, FALSE },
  /* 212 */
  { MPITYPE_COLLECTIVE, MPI_DIST_GRAPH_CREATE_ADJACENT_VAL, MPI_DIST_GRAPH_CREATE_ADJACENT_LABEL, BLOCK_ID_MPI_Dist_graph_create_adjacent, GLOP_ID_NULL, FALSE },
  /* 213 */
  { MPITYPE_COLLECTIVE, MPI_COMM_CREATE_GROUP_VAL, MPI_COMM_CREATE_GROUP_LABEL, BLOCK_ID_MPI_Comm_create_group, GLOP_ID_NULL, FALSE },
  /* 214 */
  { MPITYPE_COLLECTIVE, MPI_EXSCAN_VAL, MPI_EXSCAN_LABEL, BLOCK_ID_MPI_Exscan, GLOP_ID_MPI_Exscan, FALSE },
  /* 215 */
  { MPITYPE_COLLECTIVE, MPI_IEXSCAN_VAL, MPI_IEXSCAN_LABEL, BLOCK_ID_MPI_Iexscan, GLOP_ID_NULL, FALSE },
...
Boolean CUDAEventEncoding_Is_OldSynchStream( long64_t type )
{
  return ( ( type == OLD_CUDA_SYNCH_STREAM_EV ) ? TRUE : FALSE );
}
...
{
  return ( CUDAEventEncoding_Is_CUDABlock( event.type ) == TRUE &&
           ( event.value == CUDA_LAUNCH_VAL ||
             event.value == CUDA_MEMCPY_VAL ||
...
Boolean CUDAEventEncoding_Is_CUDALaunch( struct t_event_block event )
{
...
Boolean CUDAEventEncoding_Is_CUDASync( struct t_event_block event )
{
...
Boolean CUDAEventEncoding_Is_CUDAStreamSync( struct t_event_block event )
{
