...
#  define BLOCK_TRF2PRV_TYPE( ttrf )                                     \
    ( ( ( ttrf >= MIN_TIPUS_MPI_TRF ) && ( ttrf <= MAX_TIPUS_MPI_TRF ) ) \
        ...
        : ( ( ttrf < BASE_USERCALL ) ? USER_FUNCTION : ( ( ttrf < BASE_USERBLOCK ) ? USER_CALL : USER_BLOCK ) ) )
...
#  define BLOCK_TRF2PRV_VALUE( ttrf )                                    \
    ( ( ( ttrf >= MIN_TIPUS_MPI_TRF ) && ( ttrf <= MAX_TIPUS_MPI_TRF ) ) \
        ...
        : ( ( ttrf < BASE_USERCALL ) ? ttrf - BASE_USERFUNCTION : ( ( ttrf < BASE_USERBLOCK ) ? ttrf - BASE_USERCALL : ttrf - BASE_USERBLOCK ) ) )
