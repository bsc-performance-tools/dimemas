...
struct t_block_dimemas2prv block_dimemas2prv[ NUM_MPI_ELEMENTS ] = { { MPITYPE_COLLECTIVE, MPI_ALLGATHER_VAL },        /*   1 */
...
struct t_prv_type_info prv_block_groups[ NUM_BLOCK_GROUPS ] = { { MPITYPE_PTOP, MPITYPE_PTOP_LABEL, MPITYPE_FLAG_COLOR },
...
void Block_Dimemas2Paraver_TypeAndValue( long long DimemasBlockId, long long* ParaverType, long long* ParaverValue )
{
  if ( ( DimemasBlockId >= MIN_TIPUS_MPI_TRF ) && ( DimemasBlockId <= MAX_TIPUS_MPI_TRF ) )
  {
