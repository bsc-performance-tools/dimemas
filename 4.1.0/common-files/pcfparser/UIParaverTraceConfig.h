...
class UIParaverTraceConfig {
  public:
     ...
     */
    UIParaverTraceConfig(const string pcfFile);
     ...
     */
    int getEventType(const string eventTypeValue) const;
     ...
     */
    string getEventType(const int eventTypeKey) const;
     ...
     */
    int getEventValue(const int eventTypeKey, const string eventValue) const;
     ...
     */
    string getEventValue(const int eventTypeKey, const int eventValueKey) const;
     ...
     */
    vector<unsigned int > getEventTypes() const;
     ...
     */
    vector<unsigned int > getEventValuesFromEventTypeKey(unsigned int eventTypeKey) const;
  ...
  public:
    friend ostream & operator<<(ostream & os, const UIParaverTraceConfig & ptraceConfig);
