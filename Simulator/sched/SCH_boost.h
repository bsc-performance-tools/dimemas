...
extern int SCH_boost_info( int info, struct t_thread *thread_s, struct t_thread *thread_r );
extern void SCH_boost_init( char *filename, struct t_machine *machine );
extern void SCH_boost_copy_parameters( struct t_thread *th_o, struct t_thread *th_d );
