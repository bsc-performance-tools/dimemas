...
t_boolean SIMULATOR_set_machine_definition(
        int machine_id,
        char *machine_name,
        ...
        int global_operation_model)
{
    ...
    {
        generate_error(&SIMULATOR_error_message, 
                "machine with %d does not exist", machine_id);
        return FALSE;
    }
    ...
    {
        generate_error(&SIMULATOR_error_message, 
                "invalid number of nodes (%d)", number_of_nodes);
        return FALSE;
    }
    ...
    {
        generate_error(&SIMULATOR_error_message, 
                "invalid network bandwidth (%lf)", network_bandwidth);
        return FALSE;
    }
    ...
    {
        generate_error(&SIMULATOR_error_message, 
                "invalid number of buses (%d)", number_of_buses);
        return FALSE;
    }
    ...
    {
        generate_error(&SIMULATOR_error_message, 
                "invalid global operation model (%d)", global_operation_model);
        return FALSE;
    }
...
t_boolean SIMULATOR_set_node_definition(
        int node_id,
        int machine_id,
        char *node_name,
        int no_processors,
